...
use harfbuzz::sys::{
    ...
    hb_buffer_get_glyph_positions, hb_glyph_info_get_glyph_flags, hb_face_create, hb_face_destroy, hb_face_reference, hb_face_t,
    hb_font_create, hb_font_destroy, hb_position_t, hb_shape,
};
use harfbuzz::sys::{hb_script_t, HB_GLYPH_FLAG_UNSAFE_TO_BREAK, HB_SCRIPT_DEVANAGARI};
